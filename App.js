...
import RegisterImageScreen from "./screens/RegisterImageScreen"
...
const AddStack = createStackNavigator({
  ...
  Register : {
        screen : RegisterImageScreen,
        navigationOptions : {
             headerTitle : <View style={{alignItems: "center", flex : 1}}><Text style = {{fontSize : 24}}>사진 등록</Text></View>,
    }
  }
})
